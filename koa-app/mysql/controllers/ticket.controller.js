...
exports.create = async (ctx, next, body) => {
  try{
    ...
    return ticketCreated ? ctx.body = "Ticket was created successfully.": ctx.throw(400);
  }
  catch(err){
...
exports.getAll = async (ctx, next) => {
  try{
    ...
    return tickets ? ctx.body = tickets : ctx.throw(404, `Cannot find Ticket.`);
...
exports.get = async (ctx, next)=>{
  ...
  try{
    ...
    return ticket ? ctx.body = ticket : ctx.throw(404, `Cannot find Ticket with id=${id}.`);
  }
  catch(err) {
    return ctx.throw(err.statusCode || 500, err.message);
  };
...
exports.update = async (ctx, next, body) => {
  ...
  try{
    const ticket = await Ticket.findOne({
      ...
      const flightDetails = await FlightDetails.update(body, {where: {fk_flight_id: ticket.flight_id}})
      const plane = await Plane.update(body, {where: {plane_id: ticket.Flight.plane_id}})
      const airline = await Airline.update(body, {where: {airline_id: ticket.Flight.Plane.airline_id}})
      const starting_airport = await Airport.update(body, {where: {fk_flight_id: ticket.Flight.starting_airport.airport_id}})
      const destination_airport = await Airport.update(body, {where: {fk_flight_id: ticket.Flight.destination_airport.airport_id}})
    ...
    return ticket&&flightDetails&&plane&&airline&&starting_airport&&destination_airport&&ticketUpdated ?
      ctx.body = "Ticket was updated successfully." : ctx.throw(400, `Cannot update Ticket with id=${id}.`);
  }
  catch(err) {
    return ctx.throw(err.statusCode || 500, err.message);
  }
...
exports.delete = async (ctx, next) => {
  ...
  try{
    ...
    return ticketToDelete === 1 ?  ctx.body = "Ticket was deleted successfully!" :  ctx.throw(404, `Cannot delete Ticket with id=${id}.`);
  } 
  catch(err) {
    return ctx.throw(err.statusCode || 500, err.message);
  };
